...
const TournamentBracket = () => {
    const matches = [
      ...
      const { width, height } = useWindowSize();  // A hook to listen to the window size
const finalWidth = Math.max(width - marginX, minWidth);  // Ensure a minimum width if needed
const finalHeight = Math.max(height - marginY, minHeight);  // Ensure a minimum height if needed
